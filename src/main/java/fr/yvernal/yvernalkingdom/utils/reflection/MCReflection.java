package fr.yvernal.yvernalkingdom.utils.reflection;
...
public class MCReflection {
    ...
    public static void sendPacket(Player player, Object packet) {
        try {
            ...
            Method sendPacketMethod = getMethod(Objects.requireNonNull(playerConnectionField)
                    .getType(), "sendPacket", packetClass);
